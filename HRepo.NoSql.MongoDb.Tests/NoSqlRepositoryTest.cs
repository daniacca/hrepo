...
using HRepo.NoSql.MongoDb.Tests.ExtensionMethod;
using NoSql.MongoDb.Tests;

namespace HRepo.NoSql.MongoDb.Tests
{
    ...
    public class NoSqlRepositoryTest : NoSqlBaseRepositoryTest<TestModel, ITestModelRepository>
    {
        private int TotalDoc => 10000;
